...
const quickLinks = [
  ...
  { href: "/#top-rated-movies", label: "Top Rated" },
   { href: "/up-coming-movies", label: "Upcoming" },
  { href: "/tv-series", label: "Series" },
  { href: "/coming-movies", label: "Coming Soon" },
];

export default function Footer() {
  return (
    <footer className="mt-16 border-t border-white/10 bg-[linear-gradient(180deg,rgba(10,10,12,0.96)_0%,rgba(2,6,23,1)_100%)] text-white">
      <div className="mx-auto max-w-7xl px-4 py-12 md:px-6 lg:py-16">
        <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="max-w-2xl">
            ...
            <div className="flex items-center gap-3">
              <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-linear-to-br from-yellow-400 via-amber-500 to-orange-500 text-black shadow-lg shadow-amber-500/25">
        ...
        <div className="mt-10 flex flex-col gap-3 border-t border-white/10 pt-6 text-sm text-white/50 md:flex-row md:items-center md:justify-between">
          <p>© 2026 Movies Hub. Crafted for discovering great stories.</p>
